...
public class App {
    ...
    private static void hw7() {
        ...
        // ArtPiece Test 
        System.out.println("\nTest 1: Building ID 1 and list of ArtPiece objects (Should be 3): ");
       
        String jpaQuery = "SELECT b FROM buildings b WHERE b.buildingId = 1";
        ...
        // Viewing Test
        System.out.println("\nTest 2: Visitor 1 and their viewings: ");

        jpaQuery = "SELECT v FROM viewings v WHERE v.visitor.visitorId = 1";
        
        List<Viewing> visitor1 = em.createQuery(jpaQuery, Viewing.class).getResultList();

        for (var a : visitor1) {
            System.out.println("Art Piece Title: '" + a.getArtPiece().getTitle() + "', Score: " + a.getScore());
        }
